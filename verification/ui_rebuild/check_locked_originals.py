...
ZIP_PATH = REF_DIR / "HOTFOX_18_FINAL_STYLE_REFERENCE.zip"
...
def main() -> int:
    missing = []
    mismatch = []
    # keep EXPECTED hashes in sync with MANIFEST; 17 hash below is validated in main via the dict
    expected = {
        "01_splash_brand_entry.jpeg": "8b07bd2fdaba1618ce1ab9ccff07dda678e14df336db401328accb9a22bd200a",
        "02_onboarding_connect_hotfox.jpeg": "1bc006c1b48996e79d706118ab4e9aa35ca35a7999ccdd4cf157fcd4ca6145b4",
        "03_onboarding_auto.jpeg": "466ba7c4ddcded73bf1c9d55e14604f40825e1103bef3fa54f7394ac664fcd82",
    ...
    for name, digest in expected.items():
        ...
        if actual != digest:
            mismatch.append(f"{name}: got {actual} expected {digest}")
    print(f"manifest={MANIFEST.is_file()} zip={ZIP_PATH.is_file()} missing={len(missing)} mismatch={len(mismatch)}")
