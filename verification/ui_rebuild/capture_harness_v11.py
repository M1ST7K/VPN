#!/usr/bin/env python3
"""Capture HotFox presentation states via the debug screenshot harness (V11, ru-RU)."""
...
LOCALE_PROOF = ROOT / "verification" / "ui_rebuild" / "V11_LOCALE_PROOF.txt"

PROFILES = {
    "phone": {"size": "1080x2400", "density": "420", "default_out": "actual_v11"},
    "compact": {"size": "720x1480", "density": "360", "default_out": "actual_v11_compact"},
    "tablet": {"size": "1200x1920", "density": "320", "default_out": "tablet_v11"},
    "large-tablet": {"size": "1600x2560", "density": "320", "default_out": "tablet_v11_large"},
}
...
def main() -> int:
    ...
    out_name = args.out or (
        "actual_v11_smoke" if args.mode == "smoke" and not args.screens else spec["default_out"]
    )
