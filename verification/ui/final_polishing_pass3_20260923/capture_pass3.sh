#!/usr/bin/env bash
# Fresh real-renderer captures for final polishing pass 3 (debug harness, ru-RU, 420dpi).
set -u
...
run 05_DISCONNECTED      945x2100  1.0 "Не защищено"   matrix/05_home_360.png
run 06_CONNECTING_VISUAL 945x2100  1.0 "Подключаем"    matrix/06_connecting_360.png
run 07_PROTECTED_VISUAL  945x2100  1.0 "Вы защищены"   matrix/07_connected_360.png
run 05_DISCONNECTED      1082x2402 1.0 "Не защищено"   matrix/05_home_412.png
run 07_PROTECTED_VISUAL  1082x2402 1.0 "Вы защищены"   matrix/07_connected_412.png
...
run 05_DISCONNECTED      $S 1.15 "Не защищено"              matrix/05_home_fs115.png
run 05_DISCONNECTED      945x2100 1.15 "Не защищено"        matrix/05_home_360_fs115.png
