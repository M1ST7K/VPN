...
Status: **ENGINEERING-EXIT CANDIDATE** (2.3 gate closed: round 16 `APPROVED`; 2.4 P1 checkpoint fixes in `917a0e9`, GitHub CI run `34361778626` PASS; this head requests automatic phase-exit review)
