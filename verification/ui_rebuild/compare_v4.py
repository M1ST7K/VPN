#!/usr/bin/env python3
"""Build side-by-side, 50% overlay and absdiff for 18 V4 screens."""
...
ACT = ROOT / "verification" / "ui_rebuild" / "actual_v4"
CMP = ROOT / "verification" / "ui_rebuild" / "compare_v4"
CSV_PATH = ROOT / "verification" / "ui_rebuild" / "HOTFOX_PIXEL_DIFF_RESULTS_V4.csv"
SIZE = (1080, 2400)
