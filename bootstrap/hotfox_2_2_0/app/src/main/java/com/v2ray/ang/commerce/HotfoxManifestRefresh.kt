...
object HotfoxManifestRefresh {
    ...
    fun identityOf(profile: ProfileItem): ManifestRefreshPolicy.ServerIdentity {
        ...
        val fingerprint = fingerprintOf(
            ...
            profile.headerType.orEmpty(),
            profile.host.orEmpty(),
            profile.path.orEmpty(),
            profile.seed.orEmpty(),
            profile.quicSecurity.orEmpty(),
            profile.quicKey.orEmpty(),
            profile.mode.orEmpty(),
            profile.serviceName.orEmpty(),
            profile.authority.orEmpty(),
            profile.xhttpMode.orEmpty(),
            profile.xhttpExtra.orEmpty(),
            profile.sni.orEmpty(),
            profile.alpn.orEmpty(),
            profile.fingerPrint.orEmpty(),
            profile.publicKey.orEmpty(),
            profile.shortId.orEmpty(),
            profile.spiderX.orEmpty(),
            profile.insecure?.toString().orEmpty(),
            profile.echConfigList.orEmpty(),
        )
