...
| Settings | Material item list from toolbar | launches settings/apps/routing/ads/… | `HotfoxSettingsActivity` (13) | same destinations including ads toggle | activity rows |
